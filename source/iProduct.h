...
namespace sdds
{
    ...
    {
    public:
        // Virtual destructor to make sure the dynamic descendants of the iProduct interface will not have a memory leak if or when going out of scope
        virtual ~iProduct() {}

        // to read the Stock-Keeping Unit from the console before main data entry
